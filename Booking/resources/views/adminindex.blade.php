...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700,800,900" rel="stylesheet">
		...
		<link rel="stylesheet" href="{{asset('js/min.js')}}">
  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
			<nav id="sidebar" class="active">
				<h1><a href="" class="logo" style="font-size:63px; margin-left:10px;">Booking</a></h1>
        <ul class="list-unstyled components mb-5">
          <li class="active">
            <a href="#"><span class="fa fa-home"></span> Home</a>
          </li>
          <li>
              <a href="/adminuser"><span class="fa fa-user"></span> Users</a>
          </li>
          <li>
            <a href="/adminproduct"><span class="fa fa-sticky-note"></span> Product</a>
          </li>
          <li>
            <a href="/usershow"><span class="fa fa-cogs"></span> Services</a>
          </li>
          <li>
...
<p class="text-bold" style="wight:500px">Wellcom_Admin</p>
