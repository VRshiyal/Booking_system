  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class=""><a href="/admin"><img width="50" height="50" src="https://img.icons8.com/external-kiranshastry-gradient-kiranshastry/64/external-home-finance-kiranshastry-gradient-kiranshastry.png" alt="external-home-finance-kiranshastry-gradient-kiranshastry"/> <span class="sr-only">(current)</span></a></li>
        <li><a href=""></a></li>
        <li class="dropdown">
          <a href=""></a>
      ...
      <ul class="nav navbar-nav navbar-right">
       ...
       <li>
      <a href="/cartlink" class="text-danger">Booking</a>
      </li>
