...
<input class="input100" type="emial" value="{{$data['email']}}" name="email" placeholder="Enter your email">
<span class="focus-input100"></span>
</div>
	
<div class="wrap-input100 input100-select">
<input class="input100" type="password" value="{{$data['password']}}" name="password" placeholder="Enter your password">
	<span class="focus-input100"></span>
</div>
