...
<div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
	...
	<input class="input100" type="text" value="{{$data['price']}}"  name="price" placeholder="Enter your Price">
	<span class="focus-input100"></span>
</div>

<div class="wrap-input100 input100-select">
	<span class="need">category</span>
	<div>
	<input class="input100" type="text" value="{{$data['category']}}"  name="category" placeholder="Enter your Category">
	</div>
	<span class="focus-input100"></span>
</div>

<div class="wrap-input100 input100-select">
	<span class="need">description</span>
	<div>
	<input class="input100" type="text" value="{{$data['description']}}"  name="description" placeholder="Enter your description">
	</div>
	<span class="focus-input100"></span>
</div>
