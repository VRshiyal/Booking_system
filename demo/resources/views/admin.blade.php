...
<div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
	...
	<input class="input100" type="text" name="price" placeholder="Enter your Price">
	<span class="focus-input100"></span>
</div>
...
<div class="wrap-input100 input100-select">
	...
	<div>
	<input class="input100" type="text" name="category" placeholder="Enter your Category">
	</div>
	<span class="focus-input100"></span>
</div>
...
<div class="wrap-input100 input100-select">
	...
	<textarea class="input100" name="gallery" placeholder="Your image Url Enter.."></textarea>
	<span class="focus-input100"></span>
</div>
